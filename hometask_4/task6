...
VALUES
(1,'Григор', 'Петрвич', 'Лялей', 2200, 0, '2009-11-20', NULL, 1),
...
SELECT Employees.FName AS EmployeeFirstName, Employees.LName AS EmployeeLastName,
       Customers.FName AS CustomerFirstName, Customers.LName AS CustomerLastName
FROM Orders
